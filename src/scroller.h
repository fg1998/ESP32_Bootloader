...
"                                    "
    ...
    "Thanks to: EremusONE, Fabrizio Di Vittorio, David Crespo, OulanB, bitluni, VTrucco, reyco2000, Rodolfo Guerra, Miguel Roberto, @joselitooliveira24, Sir Clive Sinclair, Guys from RobGo_RG WhatsApp Group (dont be shy, everyone!), MSX and Spectrum people from Brazil, Uruguay and around the World !!!!!!!!          "
    "   ";
